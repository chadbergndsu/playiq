...
**Source of truth:** https://github.com/chadbergndsu/solid-systems-standards (v1.6 — 2026-08-10)
...
8. **Verify against source before planning or building** — READMEs, wikis, and prior docs can be stale or incomplete. Before estimating cost/scope or writing new code, check the actual implementation (code, schema, running system) — confirm the capability doesn't already exist, and confirm docs match reality before acting on them. See `docs/verify-against-source.md` for a worked example.
...
Use the **new-system** skill (`/new-system <slug> — <purpose>`) or:

```bash
bash ~/solid-systems-standards/scripts/new-system.sh --slug my-app --purpose "…"
```

Baseline first (private repo, AGENTS.md, CI, health, Vercel). Product work only after green `npm run ci`.
...
- Process lessons (e.g. Beacon kiosk/badge hardware planning — see `docs/verify-against-source.md`) land here too, not just security
...
*Solid Systems Standards v1.6 — 2026-08-10*
